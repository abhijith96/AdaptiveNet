...
class TutorialTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Switch Links
        self.addLink(spine1, leaf1, bw=mininetUtil.LINK_BANDWIDTH)
        self.addLink(spine1, leaf4, bw=mininetUtil.LINK_BANDWIDTH)

        self.addLink(leaf1, leaf2, bw=mininetUtil.LINK_BANDWIDTH)
        self.addLink(leaf1, leaf3, bw=mininetUtil.LINK_BANDWIDTH)

        self.addLink(leaf4, leaf5, bw=mininetUtil.LINK_BANDWIDTH)
        self.addLink(leaf5, leaf6, bw=mininetUtil.LINK_BANDWIDTH)
